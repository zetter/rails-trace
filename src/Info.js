    ...
    return <Box pad="medium" className="info">
      ...
      <Tabs margin="0" justify="start" className="tabs">
        ...
        <Tab title="What it shows">
          <Box pad="none">
            <Paragraph>
              This shows every one of the <strong>2041</strong> Ruby method calls by a Rails 5.2.2 server running in production mode while it responded to a HTTP request. These method calls were captured using the <Anchor href="https://ruby-doc.org/core-2.6/TracePoint.html">TracePoint class</Anchor>. Methods are colour-coded based on which Ruby Gem they are part of.
            </Paragraph>
            <Paragraph>
